 ...
 *
 */
public class MultipleBothModule implements BothModule
{
	 ...
	 */
	public void setModules(BothModule[] modules)
	{
			...
			StatusBar statusBar, StatusViewer statusViewer)
	{
		...
		for(int i=0; i<modules.length; i++)
		{
			...
			if(parameters != null) resultParam.putAll(parameters);
			results = convert(results, parameters);
	...
	public void input(BothModule[] modules, String[] params)
	{
		this.modules = modules;
		this.parameters = params;
	}
	
	public void input(List<BothModule> modules, List<String> params)
	{
		this.modules = new BothModule[modules.size()];
